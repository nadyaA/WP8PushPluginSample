...
// Call this if you want to show message box with raw notification on WP8
PushNotification.prototype.showRawNotification = function (successCallback, errorCallback, options) {
	if (errorCallback == null) { errorCallback = function () { } }
	...
	cordova.exec(successCallback, errorCallback, "PushPlugin", "showRawNotification", options);
}
